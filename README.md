...
1. Receba um CSV com as categorias e importe para o banco de dados (o arquivo CSV deve ser construído por você)
...
1. Pode ser feito utilizando Python, NodeJs ou Golang
...
7. Código fonte deve estar em inglês.
